...
def Game():
  ...
  if EndEarlyCheck != 0:
    ...
    if CScore == 21:
      ...
      print(f"You lost! Your final hand was {User} with {UScore} points, but the computer has {Computer} at {CScore} points. Try again!\n")
    elif (CScore < UScore and UScore <= 21) or (CScore>21 and (UScore> 16 and UScore <22)):
      ...
      print(f"You lost! Your final hand was {User} with {UScore} points, and the computer had {Computer} at {CScore} points. But you bust first! Try again!\n")
...
#Hindsight: Don't really need give specific print for results. Just write a function. Looks neater
